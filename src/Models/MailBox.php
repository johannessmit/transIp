...
class MailBox
{
     ...
     */
    public function __construct($address, $spamCheckerStrength = self::SPAMCHECKER_STRENGTH_AVERAGE, $maxDiskUsage = 20, $hasVacationReply = false, $vacationReplySubject = '', $vacationReplyMessage = '')
    {
