...
class Forward
{
     ...
     */
    public function __construct($domainName, $forwardTo, $forwardMethod = Forward::FORWARDMETHOD_DIRECT, $frameTitle = '', $frameIcon = '', $forwardEverything = true, $forwardSubdomains = false, $forwardEmailTo = '')
    {
